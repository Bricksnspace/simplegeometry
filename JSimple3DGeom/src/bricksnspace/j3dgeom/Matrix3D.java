...
public class Matrix3D {
	...
	private float a=1,b=0,c=0,
				d=0,e=1,f=0,
				g=0,h=0,i=1;	// transformation matrix 3x3 (identity)
	...
	/** 
	 * Return A element
	 * @return A element (X scaling factor in a single transformation)
	 */
	public float getA() {
		return a;
	}
	...
	/**
	 * Return E element
	 * @return E element (Y scaling factor in a single transformation)
	 */
	public float getE() {
		return e;
	}
	...
	/**
	 * Return I element
	 * @return I element (Z scaling factor in a single transformation)
	 */
	public float getI() {
		return i;
	}
	...
	/**
	 * new matrix from point, as a 3D offset
	 * @param p
	 */
	public Matrix3D(Point3D p) {
...
//		
	...
	public Matrix3D moveTo(Point3D p) {
	...
	// x-axis rotation 
	public static Matrix3D getRotateX(float angle) {
	...
	// y-axis rotation
	public static Matrix3D getRotateY(float angle) {
	...
	// z-axis rotation 
	public static Matrix3D getRotateZ(float angle) {
	...
	public static Matrix3D getScale(float sx, float sy, float sz) {
	...
	public static Matrix3D rotX180() {
	...
	public static Matrix3D rotX270() {
	...
	public static Matrix3D rotY180() {
	...
	public static Matrix3D rotY270() {
	...
	public static Matrix3D rotZ180() {
	...
	public static Matrix3D rotZ270() {
	...
	public Matrix3D getOnlyRotation() {
		
		return new Matrix3D(a,b,c,d,e,f,g,h,i,0,0,0);
	}
